...
set size ratio -1
plot "WireImage.txt" using 1:2 with lines linewidth 1.5 title "Wire lines", "RidgeImage.txt" using 1:2 with lines linewidth 1.0 lc "grey60" title "Computed cup shape","Input.txt" using 1:2 lc "black" title "Data points"
...
plot "WireImage.txt" using 1:3 with lines linewidth 1.5 title "Wire lines", "RidgeImage.txt" using 1:3 with lines linewidth 1.0 lc "grey60" title "Computed cup shape","Input.txt" using 1:3 lc "black" title "Data points"
...
plot "WireImage.txt" using 2:3 with lines linewidth 1.5 title "Wire lines", "RidgeImage.txt" using 2:3 with lines linewidth 1.0 lc "grey60" title "Computed cup shape","Input.txt" using 2:3 lc "black" title "Data points"
#set terminal postscript eps
